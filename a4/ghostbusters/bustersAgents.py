...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        # Get position distributions for remaining uncaptured ghosts
        ...
        # Find the closest ghost's position
        closestGhostPosition = min(ghostPositions, key=lambda pos: self.distancer.getDistance(pacmanPosition, pos))

        # Choose the action that minimizes the maze distance to the closest ghost
        bestAction = min(legalActions, key=lambda action: self.distancer.getDistance(game.Actions.getSuccessor(pacmanPosition, action), closestGhostPosition))
